...
export default function UserAplication(){
    ...
    return (
      ...
      <div className='px-12 py-5 mt-2 pb-5 bg-blue-200 justify-items-center rounded-lg'>
        ...
        <img src="paso1.png"  className="h-96 w-full rounded-lg"alt="nature image"/>
        ...
        <Typography variant="paragraph">
            ...
            <img src="paso2.png"  className="h-64 w-96 rounded-lg"alt="nature image"/>
            ...
            <img src="paso3.png"  className="h-64 w-96 rounded-lg"alt="nature image"/>
        ...
        <Typography variant="paragraph">
            ...
            <img src="paso4.png"  className="h-96 w-96 rounded-lg"alt="nature image"/>
        ...
        <img src="paso5.png"  className="h-96 w-full rounded-lg"alt="nature image"/>
        </Typography>
        <br></br>
        ...
        <Typography variant="paragraph">
            ...
            <img src="paso6.png"  className="h-96 w-full rounded-lg"alt="nature image"/>
        </Typography>
      </div>
      </div>
    )
